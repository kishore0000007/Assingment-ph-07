        ...
        <div className="grid md:grid-cols-3 gap-5 items-start">
          ...
          <div className="bg-white rounded-2xl border border-[#E9E9E9] p-6 flex flex-col shadow-sm">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <h2 className="font-semibold text-[#1a2e29] text-lg mt-1">
                {friend.name}
              </h2>
...
<span className={`text-xs px-3 py-0.5 rounded-full font-medium ${getStatusStyle(friend.status)}`}>
  {friend.status}
              ...
              {friend.bio && (
                <p className="text-[#64748B] text-sm text-center italic mt-1">
                  "{friend.bio}"
                </p>
              )}
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white rounded-2xl border border-[#E9E9E9] p-5 text-center shadow-sm">
                <p className="text-2xl font-bold text-[#1a2e29]">
            ...
            <div className="bg-white rounded-2xl border border-[#E9E9E9] p-5 shadow-sm">
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-semibold text-[#1a2e29] text-sm">
                  Relationship Goal
                </h3>
              ...
              <p className="text-sm text-[#64748B]">
                Connect every{" "}
                <span className="font-semibold text-[#1a2e29]">
                  {friend.goal} days
                </span>
              </p>
            </div>
